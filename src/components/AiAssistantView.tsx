...
- **Offline Sync**: All telemetry and status records will synchronize automatically once internet is restored!`
  ...
  Hindi: {
    watering: `### 💧 स्मार्ट सिंचाई और पानी की सलाह [ऑफ़लाइन रिपोर्ट]
ग्रीनहाउस 14 में मिट्टी की नमी **52%** है, जो बहुत अच्छी है।
- **सिंचाई का सही समय**: दोपहर 16:30 बजे पानी देना शुरू करें।
- **सलाह**: खेत को जलमग्न करने के बजाय 3-4 मिनट के छोटे अंतराल में पानी दें।`,
    moisture: `### 📊 मिट्टी की नमी रिपोर्ट [ऑफ़लाइन रिपोर्ट]
- ग्रीनहाउस 14: नमी सभी सेंसर पर **52.4%** पर स्थिर है।
- संतरा बागान: पेड़ों की नमी **41%** है। अभी पानी की आवश्यकता नहीं है।`,
    disease: `### 🛡️ फसल रोग और पत्तों का बचाव [ऑफ़लाइन बचाव]
हवा में नमी के कारण पत्तों पर फंगल धब्बों का मामूली खतरा है।
- **सुझाव 1**: हवा के प्रवाह को बढ़ाने के लिए निचले खरपतवार और सूखे पत्तों की छंटाई करें।
- **सुझाव 2**: शाम के ठंडे समय में जैविक नीम के तेल का छिड़काव करें।`,
    solar: `### ☀️ सोलर ऊर्जा और बैटरी स्थिति [ऑफ़लाइन स्थिति]
सॉलर पैनल बढ़िया काम कर रहे हैं। आज **4.8 kW** बिजली एकत्रित की गई है।
- **बैटरी**: **82%** चार्ज है जो कि अत्यंत स्वास्थ्यवर्धक है।
- **सीधी बिजली**: धूप के दौरान पंप सीधे पैनलों से बिजली लेता है।`,
    harvest: `### 🍊 फसल की कटाई [ऑफ़लाइन सलाह]
संतरा फल पूरी तरह मीठा होने की ओर है। अगले **14 से 18 दिन** में कटाई शुरू कर सकते हैं।
- **सलाह**: फल को मीठा बनाने के लिए तोड़ाई से 5 दिन पहले थोड़ा पानी देना कम कर दें।`,
    trouble: `### 🛠️ सेंसर कैलिब्रेशन [ऑफ़लाइन निर्देश]
यदि आपके सेंसर काम करना बंद कर दें:
1. सेंसर के नोड्स को सूखे कपड़े से साफ़ कर मिट्टी में ठीक से लगाएं।
2. जांचें कि आपका वाई-फाई स्थानीय नेटवर्क (192.168.4.1) से ठीक से जुड़ा है या नहीं।`,
    hello: `### नमस्ते! मैं आपका स्मार्ट खेती सहायक हूँ 🌿 [ऑफ़लाइन सहायक]
मैं मिट्टी की नमी, सिंचाई के सही समय और सोलर बैटरी की जानकारी देने में मदद कर सकता हूँ।
आप मुझसे पूछ सकते हैं: "नमी कितनी है?" या "पानी कब देना है?"`,
    faq: `### ❓ सामान्य कृषि प्रश्नोत्तर [ऑफ़लाइन]
- **उचित स्तर**: सामान्य फसलों के लिए नमी का स्तर **45% से 70%** सबसे उत्तम माना जाता है।
- **ऑफ़लाइन सिंक**: आपके मोबाइल द्वारा किया गया बदलाव इंटरनेट जुड़ने पर तुरंत सिंक हो जाएगा।`
  },
  Punjabi: {
    watering: `### 💧 ਸਿੰਚਾਈ ਅਤੇ ਪਾਣੀ ਦੀ ਸਲਾਹ [ਆਫਲਾਈਨ ਸਲਾਹ]
ਗ੍ਰੀਨਹਾਉਸ 14 ਵਿੱਚ ਮਿੱਟੀ ਦੀ ਨਮੀ **52%** ਹੈ, ਜੋ ਕਿ ਬਹੁਤ ਵਧੀਆ ਹੈ।
- **ਪਾਣੀ ਦਾ ਸਮਾਂ**: ਅੱਜ ਸ਼ਾਮ 16:30 ਵਜੇ ਪਾਣੀ ਦੇਣਾ ਸਭ ਤੋਂ ਵਧੀਆ ਰਹੇਗਾ।
- **ਸੁਝਾਅ**: ਖੇਤ ਨੂੰ ਪਾਣੀ ਨਾਲ ਭਰਨ ਦੀ ਬਜਾਏ 3 ਮਿੰਟ ਦੇ ਛੋਟੇ ਵਕਫੇ 'ਤੇ ਪਾਣੀ ਦਿਓ।`,
    moisture: `### 📊 ਮਿੱਟੀ ਦੀ ਨਮੀ ਰਿਪੋਰਟ [ਆਫਲਾਈਨ ਰਿਪੋਰট]
- ਗ੍ਰੀਨਹਾਉਸ 14: ਨਮੀ ਸਥਿਰ ਪੱਧਰ **52.4%** 'ਤੇ ਹੈ।
- ਸੰਤਰੇ ਦਾ ਬਾਗ: ਬਾਗ ਵਿੱਚ ਨਮੀ **41%** ਹੈ। ਹਾਲੇ ਪਾਣੀ ਦੇਣ ਦੀ ਲੋੜ ਨਹੀਂ।`,
    disease: `### 🛡️ ਫਸਲਾਂ ਦੀ ਬੀਮਾਰੀ ਤੋਂ ਬਚਾਅ [ਆਫਲਾਈਨ ਬਚਾਅ]
ਹਵਾ ਵਿੱਚ ਸਿੱਲ੍ਹ ਕਾਰਨ ਪੱਤਿਆਂ 'ਤੇ ਉੱਲੀ ਦਾ ਮਾੜਾ ਅਸਰ ਪੈ ਸਕਦਾ ਹੈ।
- **ਨੁਕਤਾ 1**: ਹਵਾ ਦੇ ਵਹਾਅ ਲਈ ਹੇਠਲੇ ਜੰਗਲੀ ਘਾਹ ਅਤੇ ਪੱਤਿਆਂ ਦੀ ਛਾਂਟੀ ਕਰੋ।
- **ਨੁਕਤਾ 2**: ਸ਼ਾਮ ਵੇਲੇ ਜੈਵਿਕ ਨਿੰਮ ਦੇ ਪਾਣੀ ਦਾ ਛਿੜਕਾਅ ਕਰੋ।`,
    solar: `### ☀️ ਸੋਲਰ ਊਰਜਾ ਅਤੇ ਬੈਟਰੀ ਸਥਿਤੀ [ਆਫਲਾਈਨ ਸਥਿਤੀ]
ਸੋਲਰ ਪੈਨਲ ਵਧੀਆ ਕੰม ਕਰ ਰਹੇ ਹਨ। ਅੱਜ **4.8 kW** ਬਿਜਲੀ ਬਣਾਈ ਗਈ ਹੈ।
- **ਬੈਟਰੀ**: ਬੈਟਰੀ ਚਾਰਜ ਹਾਲੇ **82%** ਹੈ।
- **ਬਚਤ**: ਧੁੱਪ ਦੌਰਾਨ ਪੰਪ ਸਿੱਧਾ ਸੋਲਰ ਪੈਨਲ ਤੋਂ ਬਿਜਲੀ ਖਿੱਚਦਾ ਹੈ।`,
    harvest: `### 🍊 ਫਸਲ ਦੀ ਕਟਾਈ ਦੀ ਸਲਾਹ [ਆਫਲਾਈਨ ਸਲਾਹ]
ਸੰਤਰੇ ਦੇ ਰੁੱਖ ਵਧੀਆ ਫਲ ਦੇ ਰਹੇ ਹਨ। ਅਗਲੇ **14 ਤੋਂ 18 ਦਿਨਾਂ** ਵਿੱਚ ਫਲ ਤੋੜ ਸਕਦੇ ਹੋਂ।
- **ਸੁਝਾਅ**: ਮਿੱਠੇ ਫਲ ਪ੍ਰਾਪਤ ਕਰਨ ਲਈ ਤੋੜਾਈ ਤੋਂ 5 ਦਿਨ ਪਹਿਲਾਂ ਪਾਣੀ ਦੇਣਾ ਘੱਟ ਕਰ ਦਿਓ।`,
    trouble: `### 🛠️ ਸੈਂਸਰ ਅਤੇ ਯੰਤਰ ਖਰਾਬੀ ਹੱਲ [ਆਫਲਾਈਨ ਹੱਲ]
ਜੇ ਮਿੱਟੀ ਦੇ ਸੈਂਸਰ ਰੀਡਿੰਗ ਨਾ ਦੇਣ:
1. ਸੈਂਸਰ ਦੀਆਂ ਪਿੰਨਾਂ ਸਾਫ਼ ਕਰਕੇ ਦੁਬਾਰา ਮਿੱਟੀ ਵਿੱਚ ਡੂੰਘੀ ਲਗਾਓ।
2. ਜਾਂਚ ਕਰੋ ਕਿ ਵਾਈ-ਫਾਈ ਲੋਕल ਨੈੱਟਵਰਕ (192.168.4.1) ਨਾਲ ਜੁੜਿਆ ਹੋਇਆ ਹੈ।`,
    hello: `### ਸਤਿ ਸ਼੍ਰੀ ਅਕਾਲ! ਮੈਂ ਤੁਹਾਡਾ ਖੇਤੀਬਾੜੀ ਸਹਾਇਕ ਹਾਂ 🌿 [ਆਫਲਾਈਨ]
ਮੈਂ ਮਿੱਟੀ ਦੀ ਨਮੀ, ਪਾਣੀ ਦੇਣ ਦੇ ਵਕਫੇ ਅਤੇ ਸੋਲਰ ਚਾਰਜ ਬਾਰੇ ਮਦਦ ਕਰ ਸਕਦਾ ਹਾਂ।
ਤੁਸੀਂ ਮੈਨੂੰ ਕੁਝ ਵੀ ਪੁੱਛ ਸਕਦੇ ਹੋ!`,
    faq: `### ❓ ਖੇਤੀਬਾੜੀ ਸਵਾਲ-ਜਵਾਬ [ਆਫਲਾਈਨ]
- **ਸਹੀ ਪੱਧਰ**: ਮਿੱਟੀ ਦੀ ਨਮੀ **45% ਤੋਂ 70%** ਦੇ ਵਿਚਕਾਰ ਸਭ ਤੋਂ ਲਾਹੇਵੰਦ ਹੁੰਦੀ ਹੈ।
- **ਆਟੋ-ਸਿੰਕ**: ਇੰਟਰਨੈੱਟ ਆਉਣ 'ਤੇ ਸਾਰਾ ਡਾਟਾ ਆਪਣੇ ਆਪ ਅਪਡੇਟ ਹੋ ਜਾਵੇਗਾ।`
  },
  Tamil: {
    watering: `### 💧 நீர் பாசன ஆலோசனை [ஆஃப்லைன் உதவியாளர்]
பசுமைக்குடில் 14-ல் ஈரப்பதம் **52%** ஆக உள்ளது, இது உகந்த அளவு.
- **பாசன நேரம்**: சோலார் மின்சாரத்தைப் பயன்படுத்த மாலை **16:30 UTC** அளவில் பாசனம் செய்யுங்கள்.
- **ஆலோசனை**: வயலை நிரப்புவதற்குப் பதிலாக 3-4 நிமிடங்களில் சொட்டு நீர் பாசனம் செய்யவும்.`,
    moisture: `### 📊 மண்ணின் ஈரப்பதம் [ஆஃப்லைன் கட்டுப்பாடு]
- பசுமைக்குடில் 14: சென்சார்கள் **52.4%** ஈரப்பதத்தைக் காட்டுகின்றன.
- ஆரஞ்சு தோட்டம்: ஈரப்பதம் **41%** ஆக உள்ளது. இப்போது நீர் தேவையில்லை.`,
    disease: `### 🛡️ நோய் தடுப்பு முறை [ஆஃப்லைன் பாதுகாப்பு]
காற்று ஈரப்பதம் அதிகம் இருப்பதால் இலைઓમાં பூஞ்சை தாக்குதல் ஏற்படலாம்.
...
- **பேட்டரி**: **82%** சார்ஜ் உள்ளது.
- **சேமிப்பு**: பம்ப் நேரடியாக சோலாரில் இயங்கும் வசதி உள்ளது.`,
    harvest: `### 🍊 அறுவடை ஆலோசனை [ஆஃப்லைன்]
அடுத்த **14 முதல் 18 நாட்களில்** ஆரஞ்சு பழங்கள் அறுவடைக்கு தயாராகும்.
- **ஆலோசனை**: சுவையான பழங்களுக்கு அறுவடைக்கு 5 நாட்களுக்கு முன்பு நீர் பாசனத்தை குறைக்கவும்.`,
...
- **ஆஃப்லைன் சிங்க்**: இணையம் வந்தவுடன் உங்கள் தரவுகள் தானாகவே புதுப்பிக்கப்படும்.`
  ...
  Bengali: {
    watering: `### 💧 स्मार्ट सेच व জলের পরামর্শ [অফলাইন সাহায্য]
গ্রিনহাউস ১৪-তে মাটির আর্দ্রতা বর্তমানে **৫২%**, যা চমৎকার।
- **সেচের সময়**: সবচেয়ে ভালো সৌরশক্তি পেতে বিকাল **১৬:৩০ UTC** তে সেচ শুরু করুন।
- **পরামর্শ**: জমি প্লাবিত না করে অল্প সময় ৩-৪ মিনিটে ড্রিপ সেচ দিন।`,
    moisture: `### 📊 মাটির আর্দ্রতা রিপোর্ট [অফলাইন সাহায্য]
- গ্রিনহাউস ১৪: সেন্সরগুলিতে আর্দ্রতা **৫২.৪%** এ রয়েছে।
- কমলার বাগান: গাছের গোড়ার আর্দ্রতা **৪১%**। এখন জল না দিলেও চলবে।`,
    disease: `### 🛡️ পোকা ও ছত্রাকদাগ দূরীকরণ [অফলাইন সুরক্ষা]
আর্দ্রতা বেশি থাকায় পাতায় ছাতা লাগার ঝুঁকি তৈরি হয়েছে।
- **পরামর্শ ১**: ভালো বাতাসের জন্য নিচের শুকনো মরা পাতা ছাঁটাই করুন।
- **পরামর্শ ২**: সুরক্ষার জন্য সন্ধ্যায় নিম তেল স্প্রে করুন।`,
    solar: `### ☀️ সৌর শক্তি ও ব্যাটারি [অফলাইন স্থিতি]
আজ নিখুঁত আবহাওয়ায় প্রায় **৪.৮ kW** বিদ্যুৎ পাওয়া গিয়েছে।
- **ব্যাটারি**: **৮২%** চার্জ মজুত রয়েছে।
- **সাশ্রয়**: দিনের বেলা জলের পাম্প সোলার প্যানেলে সরাসরি চালিত হয়।`,
    harvest: `### 🍊 ফসল তোলার নির্দেশনা [অফলাইন সাহায্য]
আপনার বাগানের কমলালেবু আগামী **১৪ থেকে ১৮ দিনের** মধ্যে তোলার উপযুক্ত হবে।
- **পরামর্শ**: ফসল মিষ্টি পেতে তোলার ৫ দিন আগে জল দেওয়া কমিয়ে দিন।`,
    trouble: `### 🛠️ সেন্সর পিন ক্যালিব্রেশন [অফলাইন নিয়ম]
সেন্সর নিষ্ক্রিয় বা বিকল মনে হলে:
1. সেন্সরের মেটাল পিনটি শুকনো কাপড়ে মুছে ভালো করে মাটিতে লাগান।
2. আপনার লোকাল ওয়াই-ফাই সংকেত (192.168.4.1) চেক করুন।`,
    hello: `### নমস্কার! আমি আপনার স্মার্ট কৃষি সহকারী এআই 🌿 [অফলাইন]
আমি আর্দ্রতা, সেচের পরামর্শ এবং সোলার ব্যাটারির তথ্য দিতে পারি।
বাংলায় আপনার চাষ সংক্রান্ত প্রশ্ন করুন!`,
    faq: `### ❓ সাধারণ প্রশ্নোত্তর [অফলাইন]
- **সরাসরি আর্দ্রতা**: চাষাবাদের পক্ষে মাটির আর্দ্রতা **৪৫% থেকে ৭০%** রাখা আদর্শ।
- **অফলাইন সিঙ্ক**: ইন্টারনেট চালু হলে সংগৃহীত ডেটা স্বয়ংক্রিয়ভাবে সিঙ্ক হবে।`
  },
  Telugu: {
...
*(Target Response Time: 1 to 2 seconds | Served in < 20 ms)*`;
  ...
  // Track online status locally inside component for seamless UI updates
